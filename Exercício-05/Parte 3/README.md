# Verde Vida — Loja de Plantas e Jardinagem (Parte 3)
...
## Objetivo do projeto
Desenvolver, do zero, uma loja virtual **responsiva** utilizando apenas **HTML5** e **CSS3 externo**, seguindo a abordagem **Mobile First**. O projeto evolui em 5 partes; nesta Parte 3 foram implementadas a galeria completa com os 5 produtos e as 5 páginas individuais de detalhe, com CSS Grid na galeria (1 coluna no mobile, 2 no tablet, 3 no desktop).
