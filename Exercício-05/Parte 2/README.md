# Verde Vida — Loja de Plantas e Jardinagem (Parte 2)
...
## Objetivo do projeto
Desenvolver, do zero, uma loja virtual **responsiva** utilizando apenas **HTML5** e **CSS3 externo**, seguindo a abordagem **Mobile First**. O projeto evolui em 5 partes; nesta Parte 2 foram implementadas a home personalizada (header com nome e slogan, navegação, hero com CTA, destaques e rodapé) e a primeira versão do portfólio.
