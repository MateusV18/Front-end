# Verde Vida — Loja de Plantas e Jardinagem (Parte 4)
...
## Objetivo do projeto
Desenvolver, do zero, uma loja virtual **responsiva** utilizando apenas **HTML5** e **CSS3 externo**, seguindo a abordagem **Mobile First**. O projeto evolui em 5 partes; nesta Parte 4 foi implementado o menu responsivo sem JavaScript (checkbox + :checked) em todas as páginas e as media queries nos breakpoints 768px e 1024px.
...
- Commits a cada parte concluída.
